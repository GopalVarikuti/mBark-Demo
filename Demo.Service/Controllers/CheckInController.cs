    ...
    public class CheckInController : ControllerBase
    {
        ...
        public IActionResult Check([FromBody] CheckInRequest CheckIn)
        {
            ...
            using (mBarkDemoAppContext db = new mBarkDemoAppContext())
            {
                try
                {
                    var entity = db.Manifest.Where(e => (e.BookingNo == bookingNo)).FirstOrDefault();
                    ...
                    entity.CcExpiry = CheckIn.passenger.ccExpiry;
                    ...
                    entity.ProcessingStatus = CheckIn.passenger.processingStatus;
                    entity.PurposeofVisit = CheckIn.passenger.purposeOfVisit;
                    ...
                    entity.RowId = CheckIn.passenger.rowId;
                    entity.SailDate = CheckIn.passenger.sailDate;
                    entity.SeqNo= CheckIn.passenger.seqNo;
