...
namespace Demo.Service.Models
{
    public partial class Manifest
    {
        ...
        public string GQuestionRes1 { get; set; }
        public string GQuestionRes2 { get; set; }
        public string PQuestionRes1 { get; set; }
        public string PQuestionRes2 { get; set; }
        public string Barcode { get; set; }
        public string OnboardStatus { get; set; }
        public string Zone { get; set; }
        public string Success { get; set; }
        public string Message { get; set; }
        public string TimeInMillis { get; set; }
